                              ...
                              <div className="flex gap-3 flex-wrap">
                                {ROLES.map((role) => (
                                  ...
                                  >
                                    ...
                                    <span
                                      className={cn(
                                        "w-7 h-7 rounded-full border-2 border-primary/30 flex items-center justify-center transition-all duration-300 hover:shadow-lg bg-primary text-primary-foreground",
                                        field.value === role &&
